...
import static com.balancee.rewardsManagementApi.security.utils.SecurityUtils.JWT_PREFIX;
import static com.balancee.rewardsManagementApi.security.utils.SecurityUtils.PUBLIC_ENDPOINTS;
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (authorizationHeader != null) {
            ...
            JWTVerifier verifier = JWT.require(Algorithm.HMAC512("secret".getBytes()))
                    .withIssuer("rewards_management_api")
